...
class OpenShellSinglePoint(unittest.TestCase):
    def setUp(self):
        self.orbs = orbitals.Orbitals('rkf/methyl.rkf', moleculename='Methyl')
        self.lumo = self.orbs.mos['LUMO+2_A']
        self.homo = self.orbs.mos['HOMO_B']
        self.sfo = self.orbs.sfos['C(1P:x)_A']
    ...
    def test_atomic_sfo(self):
        self.assertTrue(self.orbs.sfos.uses_atomic_fragments)
